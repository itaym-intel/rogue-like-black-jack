...
- [ ] Milestone 0: Tech stack setup — Vite + React + TypeScript scaffolding.
- [ ] Milestone 1: Application shell — layout scaffolding, routing between screens, GameEngine integration hook.
- [ ] Milestone 2: Main game screen — player status, enemy status, card table, action buttons, event log.
- [ ] Milestone 3: Shop screen — souk marketplace with item grid, purchase flow, skip button.
- [ ] Milestone 4: Genie encounter screen — curse display, wish input, genie illustration.
- [ ] Milestone 5: Terminal screens — game over, victory, pre-hand consumable use.
- [ ] Milestone 6: Visual polish — Arabian Nights theme, animations, responsive layout.
- [ ] Milestone 7: Playwright end-to-end tests + unit tests for React components.
